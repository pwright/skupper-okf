...
<tr><th><a href="/docs/refdog/concepts/multi-key-listener.html">Listener-side routing policy</a></th><td>Listener-side routing policy binds a single local listener endpoint to multiple connectors in remote sites using a strategy that selects among multiple routing keys</td></tr>
