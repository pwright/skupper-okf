...
repo_url="https://github.com/skupperproject/vms.git"
branch="main"
dest="human/vms"
sources_dir="sources"
dry_run="false"
...
usage() {
  cat <<'DOC'
Usage:
  sync-human-vms.sh [options]

Fetch skupperproject/vms and populate the local human/vms/ directory with a clean
...
Options:
  ...
  --dest DIR         Destination directory, default: human/vms
...
---
type: SourceSnapshot
title: Skupper VMs source snapshot
...
# Skupper VMs source snapshot

This directory is a copied snapshot of the Skupper VMs repository.
