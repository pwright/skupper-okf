...
if [[ -n "$local_source" ]]; then
  ...
  source_dir="$tmp_dir/skupper-docs"
...
# Skupper documentation source snapshot

This directory is a copied snapshot of the Skupper documentation repository.
...
cat > "$sources_dir/skupper-docs.md" <<DOC
---
...
log "wrote $sources_dir/skupper-docs.md"
printf '%s\n' "$commit"
